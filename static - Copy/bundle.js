...
var _MenuItems = __webpack_require__(/*! ./MenuItems */ "./src/components/MenuItems.js");
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.repeatOrder = _this.repeatOrder.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: "createOrder",
    value: function createOrder(orderName, orderQuantity) {

      var custOrder = Object.keys(this.state.order).indexOf(orderName) === -1 ? Object.assign({}, this.state.order, _defineProperty({}, orderName, orderQuantity)) : Object.assign({}, this.state.order, _defineProperty({}, orderName, orderQuantity + this.state.order[orderName]));

      this.setState({ order: custOrder });
    }
  }, {
    key: "repeatOrder",
    value: function repeatOrder(_repeatOrder) {

      this.setState({ order: _repeatOrder });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "main" },
          _react2.default.createElement(_MenuItems2.default, { menu: this.state.menu,
            createOrder: this.createOrder }),
          _react2.default.createElement(_Order2.default, { order: this.state.order,
...
var Bill = function (_React$Component) {
  ...
  function Bill() {
    ...
    var _this = _possibleConstructorReturn(this, (Bill.__proto__ || Object.getPrototypeOf(Bill)).call(this));
  ...
  _createClass(Bill, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'bill_total--sum' },
          _react2.default.createElement(
            'p',
            null,
            'Subtotal: ',
            this.props.billTotal.toLocaleString('en-gb', { style: 'currency', currency: 'GBP' }),
            _react2.default.createElement('br', null),
            'Delivery fee: ',
            delivery_fee.toLocaleString('en-gb', { style: 'currency', currency: 'GBP' }),
            _react2.default.createElement('br', null),
            'Total: ',
            (this.props.billTotal + delivery_fee).toLocaleString('en-gb', { style: 'currency', currency: 'GBP' }),
            _react2.default.createElement('br', null),
            _react2.default.createElement('input', { type: 'text', name: 'voucher', placeholder: 'Discount Code', value: this.state.userCode, onChange: this.handleChange })
          ),
          this.state.userCode === discount_code ? _react2.default.createElement(
            'p',
            null,
            '10% discount applied',
            _react2.default.createElement('br', null),
            'You saved:',
            ((this.props.billTotal + delivery_fee) * .1).toLocaleString('en-gb', { style: 'currency', currency: 'GBP' }),
            _react2.default.createElement('br', null),
            'Total to pay: ',
            ((this.props.billTotal + delivery_fee) * .9).toLocaleString('en-gb', { style: 'currency', currency: 'GBP' })
          ) : ''
        )
      );
    }
...
var _OrderHistory = __webpack_require__(/*! ./OrderHistory */ "./src/components/OrderHistory.js");
...
var History = function (_React$Component) {
  ...
  function History(props) {
    ...
    _this.getHistory = _this.getHistory.bind(_this);
    _this.deleteHistory = _this.deleteHistory.bind(_this);
    _this.receiveRepeatOrder = _this.receiveRepeatOrder.bind(_this);
    return _this;
  }
  ...
  _createClass(History, [{
    ...
    value: function getHistory() {
      ...
      fetch('/orders').then(function (response) {
        ...
        _this2.setState({ orderHistory: orderData });
      }).catch(function (err) {
        console.log(err);
      });
    }
    ...
    key: "receiveRepeatOrder",
    value: function receiveRepeatOrder(orderToAdd) {
    ...
    key: "deleteHistory",
    value: function deleteHistory(orderToDelete) {
      ...
      var custOrder = Object.assign({}, this.state.orderHistory);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        Object.keys(this.state.orderHistory).slice().reverse().map(function (prevKey) {
          var orderNum = prevKey;

          return _react2.default.createElement(
            "div",
            { className: "order-history", key: orderNum },
            _react2.default.createElement(_OrderHistory2.default, {
              orderNum: orderNum,
              prevOrder: _this3.state.orderHistory[prevKey],
              deleteHistory: _this3.deleteHistory,
              receiveRepeatOrder: _this3.receiveRepeatOrder
            })
          );
        })
      );
...
var MenuItem = function (_React$Component) {
  ...
  function MenuItem(props) {
    ...
    _this.receiveOrder = _this.receiveOrder.bind(_this);
    return _this;
  }
  ...
  _createClass(MenuItem, [{
    key: "receiveOrder",
    value: function receiveOrder(orderName, orderQuantity) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "main__menu--article" },
        _react2.default.createElement(
          "div",
          { className: "menu__item", onClick: this.togglePopup },
          _react2.default.createElement(
            "header",
            { className: "main__menu--article-h2" },
            this.props.menuItem.name,
            _react2.default.createElement("br", null)
          ),
          _react2.default.createElement(
            "header",
            { className: "main__menu--article-h3" },
        ...
        this.state.showPopup ? _react2.default.createElement(_Popup2.default, { name: this.props.menuItem.name,
          price: this.props.menuItem.price,
          minQuantity: 1,
          closePopup: this.togglePopup,
          receiveOrder: this.receiveOrder }) : null
      );
    }
  }]);
...
var _MenuItem = __webpack_require__(/*! ./MenuItem */ "./src/components/MenuItem.js");

var _MenuItem2 = _interopRequireDefault(_MenuItem);

var _History = __webpack_require__(/*! ./History */ "./src/components/History.js");
...
var MenuItems = function (_React$Component) {
        ...
        _react2.default.createElement(
          ...
          this.props.menu.map(function (menuItem) {
            return _react2.default.createElement(_MenuItem2.default, {
              key: menuItem.id,
              menuItem: menuItem,
              receiveOrder: _this2.receiveOrder
            });
          })
        )
        // </div>
...
var _Bill = __webpack_require__(/*! ./Bill */ "./src/components/Bill.js");
...
var Order = function (_React$Component) {
  ...
  _createClass(Order, [{
    ...
    key: "receiveRepeatOrder",
    value: function receiveRepeatOrder(repeatOrder) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "main__order" },
        _react2.default.createElement(
          "h2",
          null,
          "Order history "
        ),
        _react2.default.createElement(_History2.default, { receiveRepeatOrder: this.receiveRepeatOrder }),
        _react2.default.createElement(
          "div",
          { className: "bill__total" },
          Object.keys(this.props.order).map(function (orderItem) {
            for (var i = 0; i < _this2.props.menu.length; i++) {
              if (_this2.props.menu[i].name === orderItem) {
                billTotal += _this2.props.menu[i].price * _this2.props.order[orderItem];
                return _react2.default.createElement(
                  "li",
                  { key: orderItem, className: "order-line" },
                  _this2.props.order[orderItem],
                  "x ",
                  orderItem,
                  " ",
                  (_this2.props.menu[i].price * _this2.props.order[orderItem]).toLocaleString('en-gb', { style: 'currency', currency: 'GBP' })
                );
              }
            }
          }),
          _react2.default.createElement(_Bill2.default, { billTotal: billTotal,
...
function OrderHistory(_ref) {
  var orderNum = _ref.orderNum,
      ...
      receiveRepeatOrder = _ref.receiveRepeatOrder;
  ...
  return _react2.default.createElement(
    ...
    "Order: ",
    orderNum,
    Object.keys(prevOrder).map(function (lineItem) {
      return _react2.default.createElement(
        "li",
        { key: lineItem, className: "order-line" },
        prevOrder[lineItem],
        " x ",
        lineItem
      );
...
var Popup = function (_React$Component) {
  ...
  function Popup(props) {
    ...
    _this.state = {
      orderQuantity: _this.props.minQuantity //default of 1
    };
  ...
  _createClass(Popup, [{
    key: 'handleDecrease',
    value: function handleDecrease(event) {
      event.preventDefault();
      this.state.orderQuantity > 1 ? this.setState({ orderQuantity: this.state.orderQuantity - 1 }) : null;
    }
  }, {
    key: 'handleIncrease',
    ...
    key: 'addOrder',
    value: function addOrder(event) {
      event.preventDefault();

      event.target.name === "add" ? this.props.receiveOrder(this.props.name, this.state.orderQuantity) : null;
    ...
    value: function render() {
      ...
      var popupTotal = (this.state.orderQuantity * this.props.price).toLocaleString('en-gb', { style: 'currency', currency: 'GBP' });
